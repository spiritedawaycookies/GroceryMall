...
const ProductCard: React.FC<{key:number,name:string,image:string,price:number,sales:number,isSale:boolean}>=(props:{key:number,name:string,image:string,price:number,sales:number,isSale:boolean}) =>{
