...
const Footer = () => {
    ...
    const [lang, setLang] = useState(storeState.language);
    const [langList, setLangList] = useState(storeState.languageList);
            ...
            <div className="container py-4">
                <div className="row gy-4 gx-5">
                    <div className="col-lg-4 col-md-6">
                        <h5 className="h1 text-white"> The Best Grocery </h5>
                    ...
                    <div className="col-lg-2 col-md-6" style={{ position: 'relative', top: '10px' }}>
                        ...
                        <ul className="list-unstyled text-muted">
                            ...
                            <Link to={'/register'}><li><a href="#">Get Started</a></li></Link>
                            <Link to={'/deals'}>   <li><a href="#">Deals</a></li></Link>
